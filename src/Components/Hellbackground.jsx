...
const fragmentShaderSource = `
  ...
  vec4 effect(vec2 screenSize, vec2 screen_coords) {
      ...
      return (0.3/CONTRAST)*COLOUR_1 + (1. - 0.3/CONTRAST)*(COLOUR_1*c1p + COLOUR_1*c2p + vec4(c3p*COLOUR_3.rgb, c3p*COLOUR_1.a)) + light;
  }
...
function HellBackground({
  ...
  return (
    <div className={`w-full max-w-screen h-full overflow-hidden relative ${className}`}>
      <canvas
        ref={canvasRef}
